...
public class AgregarObservacion extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_geoLatitud = ((EditText) findViewById(R.id.latitud));
        txt_geoLongitud = ((EditText) findViewById(R.id.longitud));
        txt_altitud = ((EditText) findViewById(R.id.altitud));
        ...
        cmbLocalidad = ((Spinner) findViewById(R.id.Localidad));
        ObtenerLocalidadesTask tarea = new ObtenerLocalidadesTask();
        tarea.execute();
        ...
        Siguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                agregarObservacion(view);
            }
        });

        cmbFenomeno = ((Spinner) findViewById(R.id.Fenomeno));
      ObtenerFenomenosTask tareaFenomenos = new ObtenerFenomenosTask();
        ...
        cmbFenomeno.setOnItemSelectedListener((AdapterView.OnItemSelectedListener) this);
         ...
         cmbUsuario = ((Spinner) findViewById(R.id.Usuario));
        ObtenerUsuariosTask tareaUsuarios = new ObtenerUsuariosTask();
        ...
        cmbCriticidad = ((Spinner) findViewById(R.id.NivelCritico));
        ...
        eText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                picker = new DatePickerDialog(AgregarObservacion.this,
    ...
    public void agregarObservacion(View v) {
        ...
        try {
            ...
            EditText txt_descripcion = ((EditText) findViewById(R.id.descripcion));
            eText = ((EditText) findViewById(R.id.fecha));


            fecha = ((EditText) findViewById(R.id.fecha)).getText().toString();
            altitud = ((EditText) findViewById(R.id.altitud)).getText().toString();
            Latitud = ((EditText) findViewById(R.id.latitud)).getText().toString();
            Longitud = ((EditText) findViewById(R.id.longitud)).getText().toString();
            descripcion = ((EditText) findViewById(R.id.descripcion)).getText().toString();
                            ...
                            if (fenomeno.trim().compareTo("") != 0) {
                                if (localidad.trim().compareTo("") != 0) {
                                    if (idUsuario.trim().compareTo("") != 0) {
                                        ...
                                        Intent intent = new Intent(this, DetalleObservacion.class);
...
//Me traigo el json con las ciudades
                ...
                adapterLocalidad = new ArrayAdapter<>(AgregarObservacion.this, android.R.layout.simple_spinner_dropdown_item, localidades);
...
//Me traigo el json con las ciudades
                    ...
                    adpFenomeno = new ArrayAdapter<>(AgregarObservacion.this, android.R.layout.simple_spinner_dropdown_item,fenomenos);
...
//Me traigo el json con las ciudades
                ...
                adpUsuario = new ArrayAdapter<>(AgregarObservacion.this, android.R.layout.simple_spinner_dropdown_item,usuarios);
